                    ...
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex-1 flex flex-col items-center">
                            ...
                            <button
                                ...
                                className={`flex h-8 w-16 shrink-0 items-center justify-center rounded-lg border-2 transition active:translate-y-[1px] active:translate-x-[1px] mx-auto ${
                                    showChords
                                        ? 'border-black/20 bg-black/5 text-blue-700 hover:bg-black/10 dark:border-white/20 dark:bg-white/10 dark:text-blue-400 dark:hover:bg-white/20'
                                        : 'border-black/20 bg-black/5 text-black hover:bg-black/10 dark:border-white/20 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 opacity-50'
                                }`}
                                title={showChords ? 'Сховати акорди' : 'Показати акорди'}
                            >
                                <svg 
                                    viewBox="-61.2 -61.2 734.40 734.40" 
                                    className="h-full w-full fill-current transition-transform scale-[1.2]"
                                >
